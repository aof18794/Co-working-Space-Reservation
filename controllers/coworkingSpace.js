...
//@route    GET /api/v1/coworkings/:coworkingId
//@accress  Public
exports.getCoworkingSpace = async (req, res, next) => {
  try {
    const id = req.params.coworkingId;
    const coworking = await CoworkingSpace.findById(id).populate(
      "reservations"
    );
...
//@route    PUT /api/v1/coworkings/:coworkingId
//@accress  Private, Admin
...
//@route    DELETE /api/v1/coworkings/:coworkingId
//@accress  Private, Admin
